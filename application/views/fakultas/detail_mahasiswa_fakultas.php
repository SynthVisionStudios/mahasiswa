            ...
            <div class="card mb-3">
              ...
              <div class="card-body x_content">
                <div class="x_title">
                  ...
                  <div class="item form-group">
  <label class="col-form-label col-md-6 col-sm-6 label-align" for="agama">Agama : </label>
  <div class="col-md-6 col-sm-6 ">
    <select class="select2_single form-control" name="agama" tabindex="-1" required>
      ...
      <option value="Kepercayaan Lain" <?php if ($mahasiswa->agama == "Kepercayaan Lain") echo "selected"; ?>>Kepercayaan Lain</option>
    </select>
  </div>
</div>
<div class="item form-group">
    <label class="col-form-label col-md-6 col-sm-6 label-align" for="semester">Semester : </label>
    <div class="col-md-6 col-sm-6 ">
        <select class="select2_single form-control" name="semester" tabindex="-1">
            ...
            <option value="6"  ($mahasiswa->6 </option>)
        </select>
    </div>
</div>
      ...
      <div class="modal-body">
        <form role="form" action="<?php echo site_url('fakultas/edit/'.$mahasiswa->id_mahasiswa) ?>" method="post">
          <div class="item form-group">
            ...
            <div class="item form-group">
    <label class="col-form-label col-md-3 col-sm-3 label-align" for="agama">Agama</label>
    <div class="col-md-6 col-sm-6 ">
        <select class="select2_single form-control" name="agama" tabindex="-1" required>
...
<div class="item form-group">
    <label class="col-form-label col-md-3 col-sm-3 label-align" for="semester">Semester</label>
    <div class="col-md-6 col-sm-6">
        <select class="select2_single form-control" name="semester" tabindex="-1" required>
